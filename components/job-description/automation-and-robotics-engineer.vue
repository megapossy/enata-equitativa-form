<template>
  <div>
    ...
    <ul class="list-disc list-outside">
      ...
      <li>Knowledge of Rust programing.</li>
    ...
    <ul class="list-disc list-outside">
      ...
      <li>Genreral CAD software knowledge</li>
    </ul>
    ...
    <ul class="list-disc list-outside">
      <li>Automation of composite parts production line including trimming and pick-and-place of fabric plies and
        hydraulic press.</li>
      <li>Setup hardware.</li>
      <li>Program the robots.</li>
      <li>Develop and add IOT (raspberry pi like) devices to control the robots and various devices in Rust.</li>
      <li>Connect the IOT devices to the JAVA based online ERP system.</li>
    </ul>
  </div>
</template>
